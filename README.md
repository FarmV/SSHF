...
Программа специальных возможностей, позваляет буквально в 2 нажатия клавиш использовать скриншот, как окно верхнего уровня, в виде визуальной закладки (пока одной). Особенно актуально при использовании единственного монитора, потому что нет необходимости постоянно переключатся между окнами, а визуальная закладка занимает минимальное рабочее пространство на экране, равное размеру скриншота. 
## Общее
...
- Остановка обновления положения окна, клавиша CTRL, или Left Mouse Click по области скриншота.
...
- Клавиша Scroll Lock вызывает MsScreenClip. Это поведение можно выключить добавив аргумент запуска --SCR_NotBR (это удобно, така как клавиша не используется, и ее легко добавить в макросы, например на дополнительную кнопку мыши)
