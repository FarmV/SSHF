...
namespace SSHF.Infrastructure.Interfaces
{
    ...
    {   
        ...
        internal abstract Task<Tuple<bool,object?,string>> Registration(VKeys? keyCombinateon, Action<object?> actionMethod, AsyncCallback? callbackMethod, bool keyisOne = false);
    }
}
